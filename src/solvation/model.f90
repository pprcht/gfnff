...
module gfnff_solv_model
  use iso_fortran_env,only:wp => real64,stderr => error_unit

  use gfnff_solv_util,only:lowercase,rdpath

  use gfnff_solv_vdwrad_d3,only:vanDerWaalsRadD3
  use gfnff_solv_vdwrad_cosmo,only:vanDerWaalsRadCosmo

  use gfnff_solv_gbsa,only:TBorn,init_ => init
  use gfnff_solv_input,only:TSolvInput
  use gfnff_solv_kernel,only:gbKernel
  use gfnff_solv_state,only:solutionState,getStateShift
